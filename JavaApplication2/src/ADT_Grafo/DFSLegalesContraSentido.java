 ...
 * @author Veronica
 */
public class DFSLegalesContraSentido {
    private UtilsRecorrido controlMarcados;
    private Grafos grafo;
    private List<Integer> recorrido;
    
    public DFSLegalesContraSentido(Grafos unGrafo, int posVerticePartida){
         this.grafo = unGrafo;
    ...
    public void procesarDFS(int posVertice){
        ...
        Iterable<Integer> adyacentesDeVerticeEnTurno = grafo.adyacentesDeVerticeLegasleContraSentidos(posVertice);        
